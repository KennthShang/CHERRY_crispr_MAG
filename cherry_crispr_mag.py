...
parser.add_argument('--ident', help='ident threshold for the alignment', type=float, default = 90)
parser.add_argument('--coverage', help='coverage threshold for the CRISPRs', type=float, default = 0.90)
